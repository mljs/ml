 ...
 */
function n(t,e,r){this.obj=t,this.left=null,this.right=null,this.parent=r,this.dimension=e}r.r(e);class i{constructor(t,e){if(Array.isArray(t)){this.dimensions=new Array(t[0].length);for(var r=0;r<this.dimensions.length;r++)this.dimensions[r]=r;this.root=function t(e,r,i,o){const s=r%o.length;if(0===e.length)return null;if(1===e.length)return new n(e[0],s,i);e.sort((t,e)=>t[o[s]]-e[o[s]]);const a=Math.floor(e.length/2);const h=new n(e[a],s,i);h.left=t(e.slice(0,a),r+1,h,o);h.right=t(e.slice(a+1),r+1,h,o);return h}(t,0,null,this.dimensions)}else this.dimensions=t.dimensions,this.root=t,function t(e){e.left&&(e.left.parent=e,t(e.left));e.right&&(e.right.parent=e,t(e.right))}(this.root);this.metric=e}toJSON(){const t=function t(e){const r=new n(e.obj,e.dimension,null);e.left&&(r.left=t(e.left));e.right&&(r.right=t(e.right));return r}(this.root);return t.dimensions=this.dimensions,t}nearest(t,e,r){const n=this.metric,i=this.dimensions;var s;const a=new o(function(t){return-t[1]});if(r)for(s=0;s<e;s+=1)a.push([null,r]);this.root&&function r(o){const s=i[o.dimension],h=n(t,o.obj),u={};var l,c,f,g;function m(t,r){a.push([t,r]),a.size()>e&&a.pop()}for(g=0;g<i.length;g+=1)g===o.dimension?u[i[g]]=t[i[g]]:u[i[g]]=o.obj[i[g]];c=n(u,o.obj),null!==o.right||null!==o.left?(r(l=null===o.right?o.left:null===o.left?o.right:t[s]<o.obj[s]?o.left:o.right),(a.size()<e||h<a.peek()[1])&&m(o,h),(a.size()<e||Math.abs(c)<a.peek()[1])&&null!==(f=l===o.left?o.right:o.left)&&r(f)):(a.size()<e||h<a.peek()[1])&&m(o,h)}(this.root);const h=[];for(s=0;s<Math.min(e,a.content.length);s+=1)a.content[s][0]&&h.push([a.content[s][0].obj,a.content[s][1]]);return h}}class o{constructor(t){this.content=[],this.scoreFunction=t}push(t){this.content.push(t),this.bubbleUp(this.content.length-1)}pop(){var t=this.content[0],e=this.content.pop();return this.content.length>0&&(this.content[0]=e,this.sinkDown(0)),t}peek(){return this.content[0]}size(){return this.content.length}bubbleUp(t){for(var e=this.content[t];t>0;){const r=Math.floor((t+1)/2)-1,n=this.content[r];if(!(this.scoreFunction(e)<this.scoreFunction(n)))break;this.content[r]=e,this.content[t]=n,t=r}}sinkDown(t){for(var e=this.content.length,r=this.content[t],n=this.scoreFunction(r);;){var i=2*(t+1),o=i-1,s=null;if(o<e){var a=this.content[o],h=this.scoreFunction(a);h<n&&(s=o)}if(i<e){var u=this.content[i];this.scoreFunction(u)<(null===s?n:h)&&(s=i)}if(null===s)break;this.content[t]=this.content[s],this.content[s]=r,t=s}}}var s=r(2),a=r.n(s);r.d(e,"default",function(){return h});class h{constructor(t,e){let r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:{};if(!0===t){const t=e;return this.kdTree=new i(t.kdTree,r),this.k=t.k,this.classes=new Set(t.classes),void(this.isEuclidean=t.isEuclidean)}const n=new Set(e),{distance:o=a.a,k:s=n.size+1}=r,h=new Array(t.length);for(var u=0;u<h.length;++u)h[u]=t[u].slice();for(u=0;u<e.length;++u)h[u].push(e[u]);this.kdTree=new i(h,o),this.k=s,this.classes=n,this.isEuclidean=o===a.a}static load(t){let e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:a.a;if("KNN"!==t.name)throw new Error("invalid model: "+t.name);if(!t.isEuclidean&&e===a.a)throw new Error("a custom distance function was used to create the model. Please provide it again");if(t.isEuclidean&&e!==a.a)throw new Error("the model was created with the default distance function. Do not load it with another one");return new h(!0,t,e)}toJSON(){return{name:"KNN",kdTree:this.kdTree,k:this.k,classes:Array.from(this.classes),isEuclidean:this.isEuclidean}}predict(t){if(Array.isArray(t)){if("number"==typeof t[0])return u(this,t);if(Array.isArray(t[0])&&"number"==typeof t[0][0]){const r=new Array(t.length);for(var e=0;e<t.length;e++)r[e]=u(this,t[e]);return r}}throw new TypeError("dataset to predict must be an array or a matrix")}}function u(t,e){var r=t.kdTree.nearest(e,t.k),n={},i=-1,o=-1,s=r[0][0].length-1;for(var a of t.classes)n[a]=0;for(var h=0;h<r.length;++h){var u=r[h][0][s],l=++n[u];l>o&&(i=u,o=l)}return i}}])});
